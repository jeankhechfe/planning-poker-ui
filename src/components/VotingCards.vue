<template>
  <div class="container">
    ...
    <div class="btn-group">
      ...
      <button type="button" class="vote-btn" @click="estimate(89)">89 points</button>
      <button type="button" class="vote-btn" @click="estimate(99999)">Infinity</button>
      <button type="button" class="vote-btn" @click="estimate(123456)">?</button>
    </div>
